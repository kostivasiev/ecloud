...
class DeleteTest extends ApplianceTestCase
{
    ...
    public function testDeleteAppliance()
    {
        ...
        $this->json('DELETE', '/v1/appliances/' . $appliance->uuid, [], $this->validWriteHeaders)->assertStatus(204);
    ...
    public function testDeleteApplianceUnauthorised()
    {
        ...
        $this->json('DELETE', '/v1/appliances/' . $appliance->uuid, [], $this->validReadHeaders)->assertStatus(401);
    }
}
