...
class Assign extends Job
{
    ...
    public function handle()
    {
        ...
        $nat->save();
        Log::info(get_class($this) . ' : DNAT created: destination: ' . $floatingIp->id . ' translated: ' . $resource->id);
        ...
        $nat->save();
        Log::info(get_class($this) . ' : SNAT created: source: ' . $resource->id . ' translated: ' . $floatingIp->id);
